...
var ui_controller  # FIXED: Removed type hint, will get via get_node
...
func _ready():
	...
	ui_controller = get_node_or_null("BattleUIController")  # FIXED: Get node instead of type checking
...
func _setup_player_turn():
	...
	ui_controller.enable_actions()  # ✅ Enable at turn start
...
func _execute_action(action: BattleAction, is_player: bool):
	...
	# End turn (next turn will re-enable buttons)
